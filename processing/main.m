...
rud5_OEI(:,1) = data.i1.rud5.V(data.i1.rud5.iM2 == 0);
rud5_OEI(:,2) = data.i1.rud5.AoS(data.i1.rud5.iM2 == 0);
rud5_OEI(:,3) = data.i1.rud5.CN(data.i1.rud5.iM2 == 0);
rud5_OEI(:,4) = data.i1.rud5.CY(data.i1.rud5.iM2 == 0);
rud5_OEI_V40 = rud5_OEI(rud5_OEI(:,1) == 40,:);
rud5_OEI_V20 = rud5_OEI(rud5_OEI(:,1) == 20,:);

rud10_OEI(:,1) = data.i1.rud10.V(data.i1.rud10.iM2 == 0);
rud10_OEI(:,2) = data.i1.rud10.AoS(data.i1.rud10.iM2 == 0);
rud10_OEI(:,3) = data.i1.rud10.CN(data.i1.rud10.iM2 == 0);
rud10_OEI(:,4) = data.i1.rud10.CY(data.i1.rud10.iM2 == 0);
